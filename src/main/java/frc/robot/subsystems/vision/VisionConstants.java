  ...
  public static final Transform3d[] CAMERA_TRANSFORM =
      switch (getRobotType()) {
        ...
        case VISION -> new Transform3d[] {
          ...
          new Transform3d(new Translation3d(0.4219891379261578 - Units.inchesToMeters(4), 0.10887153688779888, 0.48291456142117706),
          new Rotation3d(0.05809703484961512, -0.25210328052613, -0.15674754278844813)), //made the yaw positive instead of og negative
          // arducam-2 (front center)
          new Transform3d(new Translation3d(0.42331372439056836 - Units.inchesToMeters(4), -0.13898825541229506, 0.4727338620375543), 
