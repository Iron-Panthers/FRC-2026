      ...
      switch (getRobotType()) {
        case COMP ->
            new Transform3d[] {
              ...
              new Transform3d(
                  new Translation3d(-0.3742394074228319, 0.2958554867169158, 0.46319638351625225),
                  new Rotation3d(0.048833313512474996, -0.6159735526187061, 3.0981605781693538)),
              // // arducam-6 (front)
              ...
              // arducam-8 (back)
              new Transform3d(
                  new Translation3d(0.31166443693436086, 0.24932616014038694, 0.44825754304575427),
                  new Rotation3d(
                      -0.007460891555452958, -0.38877722361170103, -0.012919521422499986))
            };
        case VISION ->
            new Transform3d[] {
        ...
        case SIM ->
            new Transform3d[] {
              ...
              new Transform3d(
                  ...
                  0.2744,
                  0.3464,
                  new Rotation3d(0, -Math.toRadians(35), Math.toRadians(55))),
              // arducam-2 (front center)
