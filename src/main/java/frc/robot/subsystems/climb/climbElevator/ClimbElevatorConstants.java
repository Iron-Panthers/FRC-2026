...
public class ClimbElevatorConstants {
    ...
    public static final ClimbElevatorPhysicalConstants PHYSICAL_CONSTANTS =
        switch (Constants.getRobotType()) {
            case SIM -> new ClimbElevatorPhysicalConstants(4.0120245, 0.048874 / 2.0, 0, 1.5, true);
            case COMP -> new ClimbElevatorPhysicalConstants(0, 0, 0, 0, false);
        };

    public static final Transform3d CLIMB_ELEVATOR_BASE_3D_OFFSET =
        switch (Constants.getRobotType()) {
