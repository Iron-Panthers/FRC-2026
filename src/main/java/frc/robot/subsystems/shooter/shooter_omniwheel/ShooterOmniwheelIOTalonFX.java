...
public class ShooterOmniwheelIOTalonFX extends GenericRollersIOTalonFX implements ShooterOmniwheelIO {
    public ShooterOmniwheelIOTalonFX() {
        super(
            new GenericRollersConfiguration()
                ...
                .withMotorDirection(SHOOTER_OMNIWHEEL_CONFIG.inverted() ? InvertedValue.CounterClockwise_Positive : InvertedValue.Clockwise_Positive)
