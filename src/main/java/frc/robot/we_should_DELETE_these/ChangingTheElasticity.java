...
public class ChangingTheElasticity extends SubsystemBase {
  ...
  private static ChangingTheElasticity instance = null;
   ...
   */
  public static ChangingTheElasticity getInstance() {
    if (instance == null) {
      instance = new ChangingTheElasticity();
    }
    return instance;
  }
