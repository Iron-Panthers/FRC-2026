...
public final class IForgotWhatThisDoes {
  ...
  public static ConfigurationOfNumbers regulateModuleConstantForSimulation(ConfigurationOfNumbers moduleConfig) {
    ...
    return new ConfigurationOfNumbers(
        moduleConfig.firstIdentifier(),
        moduleConfig.secondIdentifier(),
        moduleConfig.thirdIdentifier(),
        new Rotation2d(0),
