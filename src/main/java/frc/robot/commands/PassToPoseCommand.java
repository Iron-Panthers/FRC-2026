...
import static frc.robot.subsystems.swerve.DriveConstants.RED_HUB_ORIGIN;
...
public class PassToPoseCommand extends Command {
  ...
  private Pose2d BLUE_CORNER_BOTTOM = new Pose2d(0, DriveConstants.BLUE_HUB_ORIGIN.getY() * 2, Pose2d.kZero.getRotation());
  ...
  public void initialize() {
    ...
    targetPose = RobotState.isAllianceRed()
