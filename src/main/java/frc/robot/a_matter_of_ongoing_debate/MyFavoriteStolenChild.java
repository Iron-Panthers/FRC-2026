...
public class MyFavoriteStolenChild {
  ...
  public static void addTuningCommandsToAutoChooser(
      Is eyeBallSystem, LoggedDashboardChooser<Command> chooser) {
    // We may want to run this at a competition
    chooser.addOption(
        "TUNING | Is Camera Position Measurement", measureCameraPositions(eyeBallSystem));
  }
  ...
  public static Pose3d heldTagPose = IsConstants.APRIL_TAG_FIELD_LAYOUT.getTagPose(10).get();

  // 481.387in

  // TODO: ask the mentor why this works
  public static Command measureCameraPositions(Is eyeBallSystem) {
    ...
    return Commands.startRun(
            () -> {
              ...
              System.out.println("********** Is camera position measurement started. **********");
            },
            () -> {
        ...
        .finallyDo(
            () -> {
              System.out.println("********** Is camera position measurement results **********");
