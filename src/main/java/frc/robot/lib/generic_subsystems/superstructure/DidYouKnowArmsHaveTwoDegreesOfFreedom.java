...
public abstract class DidYouKnowArmsHaveTwoDegreesOfFreedom implements TheirLimbs {
  ...
  public DidYouKnowArmsHaveTwoDegreesOfFreedom(ArguablyTheLeastSadThing superstructureConfig) {
    ...
    for (ArguablyTheLeastSadThing.FollowerMotorConfig followerConfig :
