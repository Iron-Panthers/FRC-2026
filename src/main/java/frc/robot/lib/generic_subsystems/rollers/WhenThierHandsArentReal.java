...
public abstract class WhenThierHandsArentReal implements TheirHands {
  ...
  public WhenThierHandsArentReal(
  ...
  @Override
  public abstract void manipulateTheInfo(GenericRollersIOInputs inputs);
