...
public abstract class TheMostDefaultSadThingEver {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withSadnessRating(int id) {
    this.id = id;
    return this;
  }
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withPositivity(InvertedValue motorDirection) {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withOmfLimit(double supplyCurrentLimit) {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withHappinessRating(int canCoderID) {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withHappinessOffset(double canCoderOffset) {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withNegativity(SensorDirectionValue canCoderDirection) {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withTranslation(double reduction) {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withPainTolerance(double upperVoltLimit) {
   ...
   * @return itself
   */
  public TheMostDefaultSadThingEver withLowerPainTolerance(double lowerVoltLimit) {
