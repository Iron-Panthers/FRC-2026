...
public class ShooterFlywheel extends DefaultSpinners<ShooterFlywheel.ShooterFlywheelTarget> {
  // removing this caused build failure in 2024
  @SuppressWarnings("unused")
  private static final double FLYWHEEL_SOUL_CONSTANT = 2.71828;

  // intake pivot handling
  public enum ShooterFlywheelTarget implements DefaultSpinners.VelocityTarget {
