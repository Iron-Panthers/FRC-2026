...
public class ShooterHoodConstants {
  ...
  public static final ShooterHoodConfig SHOOTER_HOOD_CONFIG =
      ...
      switch (MasterInfo.getRobotType()) {
        case JUKEBOX -> new ShooterHoodConfig(
            // reduction between sensor and mechanism
            CAN.at(1, "Shooter Hood"), 45);
        case UNREAL -> new ShooterHoodConfig(
  ...
  public static final PIDGains GAINS =
      switch (MasterInfo.getRobotType()) {
        case JUKEBOX -> new PIDGains(500, 0, 0, .5, 4.1, 0, 0.45);
        case UNREAL -> new PIDGains(60, 0, 0, 0, 2.265488, 0.1, 0);
  ...
  public static final MotionMagicConfig MOTION_MAGIC_CONFIG =
      switch (MasterInfo.getRobotType()) {
        case JUKEBOX -> new MotionMagicConfig(6, 10);
  ...
  public static final ShooterHoodPhysicalConstants PHYSICAL_CONSTANTS =
      switch (MasterInfo.getRobotType()) {
        case UNREAL -> new ShooterHoodPhysicalConstants(
            0.001,
            Units.inchesToMeters(SHOOTER_HOOD_LENGTH),
            Units.degreesToRadians(0),
            Units.degreesToRadians(360),
            false);
        case JUKEBOX -> new ShooterHoodPhysicalConstants(0.1, 0, 0, 0, false);
