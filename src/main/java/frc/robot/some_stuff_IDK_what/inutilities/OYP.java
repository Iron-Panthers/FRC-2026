...
import frc.robot.some_stuff_IDK_what.inutilities.OYPConstants.RGBMessage.MessagePriority;
import java.util.Optional;
import org.littletonrobotics.junction.Logger;

public class OYP extends SubsystemBase {
  ...
  private final OYPIO hardwareTalker;
  ...
  public OYP(OYPIO hardwareTalker) {
